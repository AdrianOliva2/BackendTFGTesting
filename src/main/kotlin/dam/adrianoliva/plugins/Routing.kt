...
fun Application.configureRouting(
    ...
    routing {
        ...
        createOrder(itemDTS, employeeDTS, orderDTS)
        updateOrder(itemDTS, employeeDTS, orderDTS)
        deleteOrder(itemDTS, employeeDTS, orderDTS)
        completeOrder(itemDTS, employeeDTS, orderDTS)
        getItem(itemDTS)
